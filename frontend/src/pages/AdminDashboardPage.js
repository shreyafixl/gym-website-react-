...
// ─── MOCK DATA ─────────────────────────────────────────────────────────────────
const members = [
  { id: 1, name: "John Doe", email: "john@example.com", phone: "+1-555-0101", plan: "Monthly", status: "active", expiry: "Jun 2026", joined: "May 2026", checkins: 12, trainer: "Mike", gender: "M", age: 28 },
  { id: 2, name: "Jane Smith", email: "jane@example.com", phone: "+1-555-0102", plan: "Annual", status: "active", expiry: "May 2027", joined: "May 2025", checkins: 45, trainer: "Sarah", gender: "F", age: 32 },
  { id: 3, name: "Bob Johnson", email: "bob@example.com", phone: "+1-555-0103", plan: "Quarterly", status: "expired", expiry: "Apr 2026", joined: "Jan 2026", checkins: 8, trainer: "—", gender: "M", age: 45 },
];

const trainers = [
  { id: 1, name: "Mike Johnson", avatar: "MJ", role: "Senior Trainer", specialization: "Strength Training", status: "active", clients: 12, sessions: 45, rating: 4.8, permissions: { members: true, billing: false, reports: false } },
  { id: 2, name: "Sarah Williams", avatar: "SW", role: "Yoga Instructor", specialization: "Yoga & Flexibility", status: "active", clients: 8, sessions: 32, rating: 4.9, permissions: { members: true, billing: false, reports: false } },
  { id: 3, name: "Tom Brown", avatar: "TB", role: "Cardio Coach", specialization: "Cardio & Endurance", status: "on_leave", clients: 5, sessions: 18, rating: 4.6, permissions: { members: true, billing: false, reports: false } },
  { id: 4, name: "Lisa Davis", avatar: "LD", role: "Reception", specialization: "Front Desk", status: "active", clients: 0, sessions: 0, rating: 4.5, permissions: { members: true, billing: true, reports: false } },
];

const enquiries = [
  { id: 1, name: "Alex Turner", email: "alex@example.com", phone: "+1-555-0201", status: "new", date: "May 6, 2026", source: "Website", notes: "Interested in strength training" },
  { id: 2, name: "Emma Wilson", email: "emma@example.com", phone: "+1-555-0202", status: "contacted", date: "May 5, 2026", source: "Referral", notes: "Follow-up scheduled" },
  { id: 3, name: "Chris Lee", email: "chris@example.com", phone: "+1-555-0203", status: "converted", date: "May 1, 2026", source: "Ad", notes: "Joined as member" },
];

const classes = [
  { id: 1, name: "Morning Yoga", trainer: "Sarah", time: "6:00 AM", capacity: 20, enrolled: 18, status: "confirmed" },
  { id: 2, name: "Strength Training", trainer: "Mike", time: "8:00 AM", capacity: 15, enrolled: 14, status: "confirmed" },
  { id: 3, name: "Cardio Blast", trainer: "Tom", time: "5:00 PM", capacity: 25, enrolled: 22, status: "confirmed" },
];

const attendanceLogs = [
  { id: 1, member: "John Doe", date: "May 6, 2026", checkIn: "6:15 AM", checkOut: "7:30 AM", duration: "1h 15m", class: "Morning Yoga" },
  { id: 2, member: "Jane Smith", date: "May 6, 2026", checkIn: "8:05 AM", checkOut: "9:20 AM", duration: "1h 15m", class: "Strength Training" },
  { id: 3, member: "Bob Johnson", date: "May 6, 2026", checkIn: "5:10 PM", checkOut: "6:45 PM", duration: "1h 35m", class: "Cardio Blast" },
];

const attendanceData = [
  { day: "Mon", checkins: 142 },
  { day: "Tue", checkins: 156 },
  { day: "Wed", checkins: 138 },
  { day: "Thu", checkins: 165 },
  { day: "Fri", checkins: 172 },
  { day: "Sat", checkins: 145 },
  { day: "Sun", checkins: 128 },
];

const weeklySchedule = {
  Mon: [
    { id: 1, name: "Morning Yoga", trainer: "Sarah", time: "6:00 AM", capacity: 20, enrolled: 18 },
    { id: 2, name: "Strength Training", trainer: "Mike", time: "8:00 AM", capacity: 15, enrolled: 14 },
  ],
  Tue: [
    { id: 3, name: "Cardio Blast", trainer: "Tom", time: "5:00 PM", capacity: 25, enrolled: 22 },
  ],
  Wed: [
    { id: 4, name: "Pilates", trainer: "Sarah", time: "7:00 AM", capacity: 18, enrolled: 16 },
  ],
  Thu: [
    { id: 5, name: "HIIT Training", trainer: "Mike", time: "6:00 PM", capacity: 20, enrolled: 19 },
  ],
  Fri: [
    { id: 6, name: "Zumba", trainer: "Lisa", time: "7:00 PM", capacity: 30, enrolled: 28 },
  ],
  Sat: [
    { id: 7, name: "Weekend Bootcamp", trainer: "Tom", time: "9:00 AM", capacity: 25, enrolled: 23 },
  ],
  Sun: [
    { id: 8, name: "Relaxation Yoga", trainer: "Sarah", time: "5:00 PM", capacity: 20, enrolled: 15 },
  ],
};

const classBookings = [
  { id: 1, member: "John Doe", class: "Morning Yoga", date: "May 7, 2026", status: "confirmed", time: "6:00 AM" },
  { id: 2, member: "Jane Smith", class: "Strength Training", date: "May 7, 2026", status: "confirmed", time: "8:00 AM" },
  { id: 3, member: "Bob Johnson", class: "Cardio Blast", date: "May 7, 2026", status: "waitlisted", time: "5:00 PM" },
];

const revenueData = [3200, 3450, 3100, 3600, 3380, 3720, 3550, 3800, 3650, 3900, 3750, 4280];
const memberGrowthData = [45, 52, 58, 65, 72, 81, 89, 98, 108, 118, 129, 142];
const popularClasses = ["Morning Yoga", "Strength Training", "Cardio Blast", "HIIT Training", "Pilates"];

const equipmentLog = [
  { id: 1, name: "Treadmill A1", status: "operational", lastMaintenance: "May 1, 2026", nextMaintenance: "Jun 1, 2026" },
  { id: 2, name: "Bench Press B2", status: "operational", lastMaintenance: "Apr 15, 2026", nextMaintenance: "May 15, 2026" },
  { id: 3, name: "Dumbbells Set", status: "maintenance", lastMaintenance: "May 5, 2026", nextMaintenance: "May 12, 2026" },
];

const maintenanceLogs = [
  { id: 1, equipment: "Treadmill A1", type: "Preventive", status: "completed", date: "May 1, 2026", technician: "John Tech", cost: 150 },
  { id: 2, equipment: "Bench Press B2", type: "Repair", status: "in-progress", date: "May 6, 2026", technician: "Mike Tech", cost: 250 },
];

const completedPayments = [
  { id: 1, member: "John Doe", amount: "$50", date: "May 5, 2026", plan: "Monthly", status: "paid" },
  { id: 2, member: "Jane Smith", amount: "$200", date: "May 1, 2026", plan: "Annual", status: "paid" },
];

const dueRenewals = [
  { id: 1, member: "Bob Johnson", plan: "Quarterly", amount: "$75", dueDate: "May 10, 2026", days: 4 },
  { id: 2, member: "Tom Wilson", plan: "Monthly", amount: "$50", dueDate: "May 8, 2026", days: 2 },
];

const pendingPayments = [
  { id: 1, member: "Alex Turner", plan: "Monthly", amount: "$50", due: "Apr 10, 2026", days: 26 },
  { id: 2, member: "Emma Wilson", plan: "Quarterly", amount: "$150", due: "Mar 15, 2026", days: 52 },
];

const coupons = [
  { id: 1, code: "SUMMER20", discount: "20%", expiry: "Aug 31, 2026", status: "active_coupon", used: 45 },
  { id: 2, code: "WELCOME10", discount: "10%", expiry: "Dec 31, 2026", status: "active_coupon", used: 128 },
];

const discounts = [
  { id: 1, name: "Student Discount", percentage: 15, status: "enabled", members: 23 },
  { id: 2, name: "Senior Discount", percentage: 10, status: "enabled", members: 8 },
];

const notificationsData = [
  { id: 1, type: "info", message: "New member John Doe joined", date: "May 6, 2026", read: false },
  { id: 2, type: "warning", message: "Payment due for Bob Johnson", date: "May 5, 2026", read: false },
  { id: 3, type: "success", message: "Class booking confirmed", date: "May 4, 2026", read: true },
];

const kpiData = [
  { icon: "👥", label: "Total Members", value: "1,245", change: "+12% this month", color: "#3b82f6" },
  { icon: "💰", label: "Monthly Revenue", value: "$45,320", change: "+8% vs last month", color: "#22c55e" },
  { icon: "📅", label: "Classes Today", value: "12", change: "142 check-ins", color: "#f97316" },
  { icon: "⭐", label: "Avg Rating", value: "4.7", change: "From 156 reviews", color: "#ec4899" },
];
...
// ─── SIDEBAR ──────────────────────────────────────────────────────────────────
function Sidebar({ active, onNav, open, onClose, admin }) {
      ...
      <aside className={`ad-sidebar ${open ? "ad-sidebar-open" : ""} ${collapsed ? "ad-sidebar-collapsed" : ""}`}>
        ...
        {!collapsed && admin && (
          <div className="ad-sidebar-user">
            <div className="ad-avatar">{admin.name?.split(' ').map(n => n[0]).join('').toUpperCase() || 'A'}</div>
            <div>
...
function renderSection(active, openForm) {
  const map = {
    ...
    "all-members":        <AdminUserManagement openForm={openForm} />,
    attendance:           <AdminAttendance />,
    checkins:             <AdminAttendance />, // Reuse attendance component for now
...
export default function AdminDashboardPage() {
  const { admin, isAuthenticated, logout, isLoading: authLoading } = useAdminAuth();
  ...
  const go = useCallback(id => setActiveItem(id), []);
  const allItems = [DASHBOARD_ITEM, ...NAV_GROUPS.flatMap(g => g.items)];
  const currentLabel = allItems.find(i => i.id === activeItem)?.label || "Dashboard";
  ...
  return (
    <div className="ad-layout">
      <Sidebar active={activeItem} onNav={go} open={sidebarOpen} onClose={() => setSidebarOpen(false)} admin={admin} />
      <div className="ad-main">
        <header className="ad-topbar">
          ...
          <div className="ad-topbar-right">
            ...
            <TopbarBell onNav={go} />
            <div className="ad-avatar ad-avatar-sm">{admin?.name?.split(' ').map(n => n[0]).join('').toUpperCase() || 'A'}</div>
          </div>
        </header>
        <main className="ad-content">
          {renderSection(activeItem, openForm)}
        </main>
      </div>
